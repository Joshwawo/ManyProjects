...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <span class="preheader">Thanks for trying out ${team}. We’ve pulled together some information and resources to help you get started.</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://jorgemorales.vercel.app/login" class="f-fallback email-masthead_name">
                Creative AI
              </a>
              </td>
            </tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Welcome, ${name}!</h1>
                        <p>Thanks for trying use Creative AI. We’re thrilled to have you on board. To get the most out of ${team}, do this primary next step:</p>
                        <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
              ...
              <strong>Name:</strong> ${name}
                        ...
                        <p>If you have any questions, feel free to <a href="mailto:${process.env.user}">email our customer success team</a>. </p>
                        <p>Thanks,
                          <br>${owner} and the ${team} team</p>
                        <p><strong>${name}</strong> if you have not requested it, ignore this email</p>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">If you’re having trouble with the button above, copy and paste the URL below into your web browser.</p>
                              <p class="f-fallback sub"><a href="${vercelUrl}/confirm/${token}">Click Here</a></p>
                              <p>OR</p>
                              <p class="f-fallback sub"><a>https://jorgemorales.vercel.app/confirm/${token}</a> </p>
                            </td>
                          </tr>
                        </table>
                      </div>
